...
module nios_system_mm_interconnect_0 (
		...
		output wire [1:0]  leddriver_s1_address,                             //                               leddriver_s1.address
		output wire        leddriver_s1_write,                               //                                           .write
		input  wire [31:0] leddriver_s1_readdata,                            //                                           .readdata
		output wire [31:0] leddriver_s1_writedata,                           //                                           .writedata
		output wire        leddriver_s1_chipselect,                          //                                           .chipselect
		...
		output wire [1:0]  primenum_s1_address,                              //                                primenum_s1.address
		output wire        primenum_s1_write,                                //                                           .write
		input  wire [31:0] primenum_s1_readdata,                             //                                           .readdata
		output wire [31:0] primenum_s1_writedata,                            //                                           .writedata
		output wire        primenum_s1_chipselect,                           //                                           .chipselect
	...
	wire  [31:0] leddriver_s1_agent_m0_readdata;                                                     // leddriver_s1_translator:uav_readdata -> leddriver_s1_agent:m0_readdata
	wire         leddriver_s1_agent_m0_waitrequest;                                                  // leddriver_s1_translator:uav_waitrequest -> leddriver_s1_agent:m0_waitrequest
	wire         leddriver_s1_agent_m0_debugaccess;                                                  // leddriver_s1_agent:m0_debugaccess -> leddriver_s1_translator:uav_debugaccess
	wire  [13:0] leddriver_s1_agent_m0_address;                                                      // leddriver_s1_agent:m0_address -> leddriver_s1_translator:uav_address
	wire   [3:0] leddriver_s1_agent_m0_byteenable;                                                   // leddriver_s1_agent:m0_byteenable -> leddriver_s1_translator:uav_byteenable
	wire         leddriver_s1_agent_m0_read;                                                         // leddriver_s1_agent:m0_read -> leddriver_s1_translator:uav_read
	wire         leddriver_s1_agent_m0_readdatavalid;                                                // leddriver_s1_translator:uav_readdatavalid -> leddriver_s1_agent:m0_readdatavalid
	wire         leddriver_s1_agent_m0_lock;                                                         // leddriver_s1_agent:m0_lock -> leddriver_s1_translator:uav_lock
	wire  [31:0] leddriver_s1_agent_m0_writedata;                                                    // leddriver_s1_agent:m0_writedata -> leddriver_s1_translator:uav_writedata
	wire         leddriver_s1_agent_m0_write;                                                        // leddriver_s1_agent:m0_write -> leddriver_s1_translator:uav_write
	wire   [2:0] leddriver_s1_agent_m0_burstcount;                                                   // leddriver_s1_agent:m0_burstcount -> leddriver_s1_translator:uav_burstcount
	wire         leddriver_s1_agent_rf_source_valid;                                                 // leddriver_s1_agent:rf_source_valid -> leddriver_s1_agent_rsp_fifo:in_valid
	wire  [90:0] leddriver_s1_agent_rf_source_data;                                                  // leddriver_s1_agent:rf_source_data -> leddriver_s1_agent_rsp_fifo:in_data
	wire         leddriver_s1_agent_rf_source_ready;                                                 // leddriver_s1_agent_rsp_fifo:in_ready -> leddriver_s1_agent:rf_source_ready
	wire         leddriver_s1_agent_rf_source_startofpacket;                                         // leddriver_s1_agent:rf_source_startofpacket -> leddriver_s1_agent_rsp_fifo:in_startofpacket
	wire         leddriver_s1_agent_rf_source_endofpacket;                                           // leddriver_s1_agent:rf_source_endofpacket -> leddriver_s1_agent_rsp_fifo:in_endofpacket
	wire         leddriver_s1_agent_rsp_fifo_out_valid;                                              // leddriver_s1_agent_rsp_fifo:out_valid -> leddriver_s1_agent:rf_sink_valid
	wire  [90:0] leddriver_s1_agent_rsp_fifo_out_data;                                               // leddriver_s1_agent_rsp_fifo:out_data -> leddriver_s1_agent:rf_sink_data
	wire         leddriver_s1_agent_rsp_fifo_out_ready;                                              // leddriver_s1_agent:rf_sink_ready -> leddriver_s1_agent_rsp_fifo:out_ready
	wire         leddriver_s1_agent_rsp_fifo_out_startofpacket;                                      // leddriver_s1_agent_rsp_fifo:out_startofpacket -> leddriver_s1_agent:rf_sink_startofpacket
	wire         leddriver_s1_agent_rsp_fifo_out_endofpacket;                                        // leddriver_s1_agent_rsp_fifo:out_endofpacket -> leddriver_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> leddriver_s1_agent:cp_valid
	wire  [89:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> leddriver_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // leddriver_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> leddriver_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> leddriver_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> leddriver_s1_agent:cp_endofpacket
	wire  [31:0] primenum_s1_agent_m0_readdata;                                                      // primenum_s1_translator:uav_readdata -> primenum_s1_agent:m0_readdata
	wire         primenum_s1_agent_m0_waitrequest;                                                   // primenum_s1_translator:uav_waitrequest -> primenum_s1_agent:m0_waitrequest
	wire         primenum_s1_agent_m0_debugaccess;                                                   // primenum_s1_agent:m0_debugaccess -> primenum_s1_translator:uav_debugaccess
	wire  [13:0] primenum_s1_agent_m0_address;                                                       // primenum_s1_agent:m0_address -> primenum_s1_translator:uav_address
	wire   [3:0] primenum_s1_agent_m0_byteenable;                                                    // primenum_s1_agent:m0_byteenable -> primenum_s1_translator:uav_byteenable
	wire         primenum_s1_agent_m0_read;                                                          // primenum_s1_agent:m0_read -> primenum_s1_translator:uav_read
	wire         primenum_s1_agent_m0_readdatavalid;                                                 // primenum_s1_translator:uav_readdatavalid -> primenum_s1_agent:m0_readdatavalid
	wire         primenum_s1_agent_m0_lock;                                                          // primenum_s1_agent:m0_lock -> primenum_s1_translator:uav_lock
	wire  [31:0] primenum_s1_agent_m0_writedata;                                                     // primenum_s1_agent:m0_writedata -> primenum_s1_translator:uav_writedata
	wire         primenum_s1_agent_m0_write;                                                         // primenum_s1_agent:m0_write -> primenum_s1_translator:uav_write
	wire   [2:0] primenum_s1_agent_m0_burstcount;                                                    // primenum_s1_agent:m0_burstcount -> primenum_s1_translator:uav_burstcount
	wire         primenum_s1_agent_rf_source_valid;                                                  // primenum_s1_agent:rf_source_valid -> primenum_s1_agent_rsp_fifo:in_valid
	wire  [90:0] primenum_s1_agent_rf_source_data;                                                   // primenum_s1_agent:rf_source_data -> primenum_s1_agent_rsp_fifo:in_data
	wire         primenum_s1_agent_rf_source_ready;                                                  // primenum_s1_agent_rsp_fifo:in_ready -> primenum_s1_agent:rf_source_ready
	wire         primenum_s1_agent_rf_source_startofpacket;                                          // primenum_s1_agent:rf_source_startofpacket -> primenum_s1_agent_rsp_fifo:in_startofpacket
	wire         primenum_s1_agent_rf_source_endofpacket;                                            // primenum_s1_agent:rf_source_endofpacket -> primenum_s1_agent_rsp_fifo:in_endofpacket
	wire         primenum_s1_agent_rsp_fifo_out_valid;                                               // primenum_s1_agent_rsp_fifo:out_valid -> primenum_s1_agent:rf_sink_valid
	wire  [90:0] primenum_s1_agent_rsp_fifo_out_data;                                                // primenum_s1_agent_rsp_fifo:out_data -> primenum_s1_agent:rf_sink_data
	wire         primenum_s1_agent_rsp_fifo_out_ready;                                               // primenum_s1_agent:rf_sink_ready -> primenum_s1_agent_rsp_fifo:out_ready
	wire         primenum_s1_agent_rsp_fifo_out_startofpacket;                                       // primenum_s1_agent_rsp_fifo:out_startofpacket -> primenum_s1_agent:rf_sink_startofpacket
	wire         primenum_s1_agent_rsp_fifo_out_endofpacket;                                         // primenum_s1_agent_rsp_fifo:out_endofpacket -> primenum_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> primenum_s1_agent:cp_valid
	wire  [89:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> primenum_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // primenum_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> primenum_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> primenum_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> primenum_s1_agent:cp_endofpacket
	...
	wire         leddriver_s1_agent_rp_valid;                                                        // leddriver_s1_agent:rp_valid -> router_007:sink_valid
	wire  [89:0] leddriver_s1_agent_rp_data;                                                         // leddriver_s1_agent:rp_data -> router_007:sink_data
	wire         leddriver_s1_agent_rp_ready;                                                        // router_007:sink_ready -> leddriver_s1_agent:rp_ready
	wire         leddriver_s1_agent_rp_startofpacket;                                                // leddriver_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         leddriver_s1_agent_rp_endofpacket;                                                  // leddriver_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         primenum_s1_agent_rp_valid;                                                         // primenum_s1_agent:rp_valid -> router_008:sink_valid
	wire  [89:0] primenum_s1_agent_rp_data;                                                          // primenum_s1_agent:rp_data -> router_008:sink_data
	wire         primenum_s1_agent_rp_ready;                                                         // router_008:sink_ready -> primenum_s1_agent:rp_ready
	wire         primenum_s1_agent_rp_startofpacket;                                                 // primenum_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         primenum_s1_agent_rp_endofpacket;                                                   // primenum_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         leddriver_s1_agent_rdata_fifo_src_valid;                                            // leddriver_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] leddriver_s1_agent_rdata_fifo_src_data;                                             // leddriver_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         leddriver_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_005:in_0_ready -> leddriver_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> leddriver_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> leddriver_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // leddriver_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> leddriver_s1_agent:rdata_fifo_sink_error
	wire         primenum_s1_agent_rdata_fifo_src_valid;                                             // primenum_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] primenum_s1_agent_rdata_fifo_src_data;                                              // primenum_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         primenum_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_006:in_0_ready -> primenum_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> primenum_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> primenum_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // primenum_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> primenum_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) leddriver_s1_translator (
		.clk                    (clk_0_clk_clk),                                    //                      clk.clk
		.reset                  (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (leddriver_s1_agent_m0_address),                    // avalon_universal_slave_0.address
		.uav_burstcount         (leddriver_s1_agent_m0_burstcount),                 //                         .burstcount
		.uav_read               (leddriver_s1_agent_m0_read),                       //                         .read
		.uav_write              (leddriver_s1_agent_m0_write),                      //                         .write
		.uav_waitrequest        (leddriver_s1_agent_m0_waitrequest),                //                         .waitrequest
		.uav_readdatavalid      (leddriver_s1_agent_m0_readdatavalid),              //                         .readdatavalid
		.uav_byteenable         (leddriver_s1_agent_m0_byteenable),                 //                         .byteenable
		.uav_readdata           (leddriver_s1_agent_m0_readdata),                   //                         .readdata
		.uav_writedata          (leddriver_s1_agent_m0_writedata),                  //                         .writedata
		.uav_lock               (leddriver_s1_agent_m0_lock),                       //                         .lock
		.uav_debugaccess        (leddriver_s1_agent_m0_debugaccess),                //                         .debugaccess
		.av_address             (leddriver_s1_address),                             //      avalon_anti_slave_0.address
		.av_write               (leddriver_s1_write),                               //                         .write
		.av_readdata            (leddriver_s1_readdata),                            //                         .readdata
		.av_writedata           (leddriver_s1_writedata),                           //                         .writedata
		.av_chipselect          (leddriver_s1_chipselect),                          //                         .chipselect
		.av_read                (),                                                 //              (terminated)
		.av_begintransfer       (),                                                 //              (terminated)
		.av_beginbursttransfer  (),                                                 //              (terminated)
		.av_burstcount          (),                                                 //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) primenum_s1_translator (
		.clk                    (clk_0_clk_clk),                                    //                      clk.clk
		.reset                  (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (primenum_s1_agent_m0_address),                     // avalon_universal_slave_0.address
		.uav_burstcount         (primenum_s1_agent_m0_burstcount),                  //                         .burstcount
		.uav_read               (primenum_s1_agent_m0_read),                        //                         .read
		.uav_write              (primenum_s1_agent_m0_write),                       //                         .write
		.uav_waitrequest        (primenum_s1_agent_m0_waitrequest),                 //                         .waitrequest
		.uav_readdatavalid      (primenum_s1_agent_m0_readdatavalid),               //                         .readdatavalid
		.uav_byteenable         (primenum_s1_agent_m0_byteenable),                  //                         .byteenable
		.uav_readdata           (primenum_s1_agent_m0_readdata),                    //                         .readdata
		.uav_writedata          (primenum_s1_agent_m0_writedata),                   //                         .writedata
		.uav_lock               (primenum_s1_agent_m0_lock),                        //                         .lock
		.uav_debugaccess        (primenum_s1_agent_m0_debugaccess),                 //                         .debugaccess
		.av_address             (primenum_s1_address),                              //      avalon_anti_slave_0.address
		.av_write               (primenum_s1_write),                                //                         .write
		.av_readdata            (primenum_s1_readdata),                             //                         .readdata
		.av_writedata           (primenum_s1_writedata),                            //                         .writedata
		.av_chipselect          (primenum_s1_chipselect),                           //                         .chipselect
		.av_read                (),                                                 //              (terminated)
		.av_begintransfer       (),                                                 //              (terminated)
		.av_beginbursttransfer  (),                                                 //              (terminated)
		.av_burstcount          (),                                                 //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (leddriver_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (leddriver_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (leddriver_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (leddriver_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (leddriver_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (leddriver_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (leddriver_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (leddriver_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (leddriver_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (leddriver_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (leddriver_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (leddriver_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (leddriver_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (leddriver_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (leddriver_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (leddriver_s1_agent_rp_startofpacket),              //                .startofpacket
		...
		.rf_sink_ready           (leddriver_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (leddriver_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (leddriver_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (leddriver_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (leddriver_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (leddriver_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (leddriver_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (leddriver_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (leddriver_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (leddriver_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),                //                .error
		.rdata_fifo_src_ready    (leddriver_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (leddriver_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (leddriver_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) leddriver_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (leddriver_s1_agent_rf_source_data),                //        in.data
		.in_valid          (leddriver_s1_agent_rf_source_valid),               //          .valid
		.in_ready          (leddriver_s1_agent_rf_source_ready),               //          .ready
		.in_startofpacket  (leddriver_s1_agent_rf_source_startofpacket),       //          .startofpacket
		.in_endofpacket    (leddriver_s1_agent_rf_source_endofpacket),         //          .endofpacket
		.out_data          (leddriver_s1_agent_rsp_fifo_out_data),             //       out.data
		.out_valid         (leddriver_s1_agent_rsp_fifo_out_valid),            //          .valid
		.out_ready         (leddriver_s1_agent_rsp_fifo_out_ready),            //          .ready
		.out_startofpacket (leddriver_s1_agent_rsp_fifo_out_startofpacket),    //          .startofpacket
		.out_endofpacket   (leddriver_s1_agent_rsp_fifo_out_endofpacket),      //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (primenum_s1_agent_m0_address),                     //              m0.address
		.m0_burstcount           (primenum_s1_agent_m0_burstcount),                  //                .burstcount
		.m0_byteenable           (primenum_s1_agent_m0_byteenable),                  //                .byteenable
		.m0_debugaccess          (primenum_s1_agent_m0_debugaccess),                 //                .debugaccess
		.m0_lock                 (primenum_s1_agent_m0_lock),                        //                .lock
		.m0_readdata             (primenum_s1_agent_m0_readdata),                    //                .readdata
		.m0_readdatavalid        (primenum_s1_agent_m0_readdatavalid),               //                .readdatavalid
		.m0_read                 (primenum_s1_agent_m0_read),                        //                .read
		.m0_waitrequest          (primenum_s1_agent_m0_waitrequest),                 //                .waitrequest
		.m0_writedata            (primenum_s1_agent_m0_writedata),                   //                .writedata
		.m0_write                (primenum_s1_agent_m0_write),                       //                .write
		.rp_endofpacket          (primenum_s1_agent_rp_endofpacket),                 //              rp.endofpacket
		.rp_ready                (primenum_s1_agent_rp_ready),                       //                .ready
		.rp_valid                (primenum_s1_agent_rp_valid),                       //                .valid
		.rp_data                 (primenum_s1_agent_rp_data),                        //                .data
		.rp_startofpacket        (primenum_s1_agent_rp_startofpacket),               //                .startofpacket
		...
		.rf_sink_ready           (primenum_s1_agent_rsp_fifo_out_ready),             //         rf_sink.ready
		.rf_sink_valid           (primenum_s1_agent_rsp_fifo_out_valid),             //                .valid
		.rf_sink_startofpacket   (primenum_s1_agent_rsp_fifo_out_startofpacket),     //                .startofpacket
		.rf_sink_endofpacket     (primenum_s1_agent_rsp_fifo_out_endofpacket),       //                .endofpacket
		.rf_sink_data            (primenum_s1_agent_rsp_fifo_out_data),              //                .data
		.rf_source_ready         (primenum_s1_agent_rf_source_ready),                //       rf_source.ready
		.rf_source_valid         (primenum_s1_agent_rf_source_valid),                //                .valid
		.rf_source_startofpacket (primenum_s1_agent_rf_source_startofpacket),        //                .startofpacket
		.rf_source_endofpacket   (primenum_s1_agent_rf_source_endofpacket),          //                .endofpacket
		.rf_source_data          (primenum_s1_agent_rf_source_data),                 //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),                //                .error
		.rdata_fifo_src_ready    (primenum_s1_agent_rdata_fifo_src_ready),           //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (primenum_s1_agent_rdata_fifo_src_valid),           //                .valid
		.rdata_fifo_src_data     (primenum_s1_agent_rdata_fifo_src_data),            //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) primenum_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (primenum_s1_agent_rf_source_data),                 //        in.data
		.in_valid          (primenum_s1_agent_rf_source_valid),                //          .valid
		.in_ready          (primenum_s1_agent_rf_source_ready),                //          .ready
		.in_startofpacket  (primenum_s1_agent_rf_source_startofpacket),        //          .startofpacket
		.in_endofpacket    (primenum_s1_agent_rf_source_endofpacket),          //          .endofpacket
		.out_data          (primenum_s1_agent_rsp_fifo_out_data),              //       out.data
		.out_valid         (primenum_s1_agent_rsp_fifo_out_valid),             //          .valid
		.out_ready         (primenum_s1_agent_rsp_fifo_out_ready),             //          .ready
		.out_startofpacket (primenum_s1_agent_rsp_fifo_out_startofpacket),     //          .startofpacket
		.out_endofpacket   (primenum_s1_agent_rsp_fifo_out_endofpacket),       //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	nios_system_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (leddriver_s1_agent_rp_ready),                      //      sink.ready
		.sink_valid         (leddriver_s1_agent_rp_valid),                      //          .valid
		.sink_data          (leddriver_s1_agent_rp_data),                       //          .data
		.sink_startofpacket (leddriver_s1_agent_rp_startofpacket),              //          .startofpacket
		.sink_endofpacket   (leddriver_s1_agent_rp_endofpacket),                //          .endofpacket
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (primenum_s1_agent_rp_ready),                       //      sink.ready
		.sink_valid         (primenum_s1_agent_rp_valid),                       //          .valid
		.sink_data          (primenum_s1_agent_rp_data),                        //          .data
		.sink_startofpacket (primenum_s1_agent_rp_startofpacket),               //          .startofpacket
		.sink_endofpacket   (primenum_s1_agent_rp_endofpacket),                 //          .endofpacket
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (leddriver_s1_agent_rdata_fifo_src_data),           //     in_0.data
		.in_0_valid     (leddriver_s1_agent_rdata_fifo_src_valid),          //         .valid
		.in_0_ready     (leddriver_s1_agent_rdata_fifo_src_ready),          //         .ready
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (primenum_s1_agent_rdata_fifo_src_data),            //     in_0.data
		.in_0_valid     (primenum_s1_agent_rdata_fifo_src_valid),           //         .valid
		.in_0_ready     (primenum_s1_agent_rdata_fifo_src_ready),           //         .ready
